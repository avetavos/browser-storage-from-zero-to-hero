...
<Mermaid code={syncAsyncDiagram} title="Synchronous storage block thread ที่เรียก; asynchronous storage ให้ thread ทำงานต่อได้" />
