...
description: "วิธีที่ browser แบ่ง storage ตาม origin, ความสำคัญของ HTTPS และความเสี่ยง XSS จากการเก็บ secrets ใน client-side storage"
sidebar:
  order: 3
---
...
- **คิดว่า subdomain เดียวกันแชร์ storage กันได้** — `https://app.example.com` กับ `https://example.com` เป็นคนละ origin เพราะ host ต่างกัน แม้จะเป็น domain เดียวกันก็ตาม
