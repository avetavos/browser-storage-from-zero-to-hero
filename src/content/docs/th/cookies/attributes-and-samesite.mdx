...
export const quizAttributesSameSite = [
  {
    ...
    options: [
      ...
      'รีเซ็ตวันหมดอายุของคุกกี้เป็นค่าเริ่มต้นของ browser',
    ],
    answer: 1,
  },
  {
  ...
  {
    q: 'คุกกี้มี SameSite=None ต้องใช้ attribute อะไรเพิ่มเติมเพื่อให้ browser ยอมรับ?',
