...
แอป editor แบบ collaborative ที่เปิดหลายแท็บบนเอกสารเดียวกัน สามารถเลือกแท็บหนึ่งเป็น "leader" ที่รับผิดชอบ sync กับ server แล้ว broadcast ผลลัพธ์ไปยังแท็บอื่น ช่วยลด duplicate network request จากหลายแท็บที่ poll พร้อมกัน
</Callout>
...
export const quizCrossTabState = [
  ...
  },
  {
    ...
    options: [
      ...
      'browser ปล่อย lock ทำให้ callback ของแท็บถัดไปในคิวทำงาน',
