...
แอปเอกสารร่วมหรือแอปแชทที่เปิดหลายแท็บบน account เดียวกัน สามารถใช้ `BroadcastChannel` เพื่อซิงค์ notification badge, unread count หรือ indicator แบบ "มีคนอื่นกำลังแก้ไขอยู่" ให้ตรงกันทุกแท็บที่เปิดอยู่ โดยไม่ต้องให้แต่ละแท็บ poll server แยกกัน
</Callout>
