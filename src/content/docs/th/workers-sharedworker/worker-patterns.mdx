...
**Squoosh** เครื่องมือบีบอัดภาพโอเพนซอร์สของ Google รัน codec บีบอัดภาพใน Web Worker แหล่งอ้างอิง: [web.dev, "Squoosh v2"](https://web.dev/blog/squoosh-v2) และ [Squoosh GitHub repository](https://github.com/GoogleChromeLabs/squoosh) การห่อ worker แบบนั้นด้วย RPC pattern ที่ใช้ Promise — จับคู่แต่ละคำขอกับผลลัพธ์ด้วย message ID — ทำให้โค้ดฝั่ง UI เรียกใช้ worker ได้เหมือนเรียก async function ปกติ แทนที่จะต้องจัดการ `postMessage`/`onmessage` ดิบๆ เอง
</Callout>
