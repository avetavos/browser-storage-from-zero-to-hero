...
**Squoosh** เครื่องมือบีบอัดภาพโอเพนซอร์สของ Google รัน codec บีบอัดภาพ (MozJPEG, WebP และอื่นๆ) ใน Web Worker เพื่อไม่ให้ UI ค้างระหว่างบีบอัด แหล่งอ้างอิง: [web.dev, "Squoosh v2"](https://web.dev/blog/squoosh-v2) และ [Squoosh GitHub repository](https://github.com/GoogleChromeLabs/squoosh) worker ที่ประมวลผล buffer ขนาดใหญ่แบบนี้ (ภาพหรือเสียง) โดยทั่วไปจะได้ประโยชน์จากการ transfer pixel/sample buffer ดิบแทนการ clone เพื่อหลีกเลี่ยงการคัดลอกข้อมูลหลาย MB ในทุกเฟรม
</Callout>
