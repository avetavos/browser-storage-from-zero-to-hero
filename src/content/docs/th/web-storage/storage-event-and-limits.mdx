...
- **คาดหวังว่า `storage` event จะยิงในแท็บที่เขียนเอง** — event นี้ยิงเฉพาะใน**แท็บอื่น**เท่านั้น ถ้าต้องการอัปเดต UI ในแท็บที่เขียนด้วย ต้องเรียก logic นั้นตรง ๆ แยกจาก listener
