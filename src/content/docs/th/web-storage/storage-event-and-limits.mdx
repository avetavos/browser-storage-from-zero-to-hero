...
`storage` event เป็นสัญญาณข้ามแท็บแบบเรียบง่ายสำหรับการเปลี่ยนแปลง `localStorage` — event นี้ยิงใน **แท็บอื่นเท่านั้น** ไม่ใช่ในแท็บที่เขียน Web Storage ทำงานแบบ **synchronous** ดังนั้นจึงควรเลี่ยงการเก็บ blob ขนาดใหญ่ ให้ใช้ IndexedDB สำหรับอะไรก็ตามที่เกินไม่กี่ KB
</Callout>
...
export const quizStorageEventAndLimits = [
  ...
  },
  {
    ...
    options: [
      ...
      'เฉพาะในแท็บที่เปลี่ยนแปลงเท่านั้น',
    ],
    answer: 1,
  },
  {
