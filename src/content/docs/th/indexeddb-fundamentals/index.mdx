...
description: 'database object แบบ async ที่รองรับ transaction ใน browser — ออกแบบมาสำหรับข้อมูลที่มีโครงสร้างขนาดใหญ่และแอปออฟไลน์'
sidebar:
  order: 1
---
...
database IndexedDB แต่ละตัวมีชื่อและหมายเลขเวอร์ชัน ภายใน database จะมี **object store** อย่างน้อยหนึ่งอัน คล้ายกับตารางใน database ทั่วไป แต่ละ object store เก็บ **record** ซึ่งเป็น object JavaScript ที่ระบุตัวตนด้วย **key**
...
โค้ดด้านล่างเปิด database ยืนยันชื่อของมัน แล้วลบทิ้งเพื่อไม่ให้เหลือร่องรอย
